...
const PRODUCT_NAME = "el Mega Pack";
      ...
      <AnimatePresence>
        {visible && (
          <m.div
            ...
            className="pointer-events-auto w-[78vw] max-w-[210px] sm:max-w-[280px] bg-white border border-black/[0.06] border-l-4 border-l-green-500 rounded-xl shadow-[0_12px_32px_rgba(28,39,51,0.22)] p-2 sm:p-3.5"
          >
            <div className="flex items-start justify-between gap-2 mb-1">
              <span className="inline-flex items-center gap-1.5 text-[9px] sm:text-xs font-bold uppercase tracking-wide text-green-700">
              ...
              <button
                ...
                className="text-slate-400 hover:text-slate-600 leading-none text-xs sm:text-sm -mt-0.5"
              >
                ✕
              </button>
            </div>
            <p className="text-[#1C2733] text-[11px] sm:text-sm leading-snug">
