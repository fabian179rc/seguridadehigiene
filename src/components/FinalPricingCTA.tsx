  ...
  return (
    <section className="py-16 md:py-24 bg-[#f4efe2] text-center relative overflow-hidden pt-[30px] pb-[30px]">
      <div className="container mx-auto px-4 max-w-[1100px] relative z-10">
        ...
        <p className="text-lg md:text-xl text-[#4b5347] mb-10 max-w-2xl mx-auto">
        ...
        <motion.a
          ...
          className="inline-flex items-center justify-center gap-2 md:gap-3 bg-[#b85c43] hover:bg-[#a34f38] text-white font-extrabold text-[12px] md:text-xl px-5 md:px-8 py-6 rounded-full shadow-lg shadow-[#b85c43]/30 transition-colors mb-8"
        >
